...
Douban.init_show_login = function (o) {
  var extractAppNameFromDomain = function extractAppNameFromDomain() {
    var appName = '';
    var matches = location.hostname.match(/(.*)\.douban\.com/);
    if (matches) {
      appName = matches[1];
    }
    var REG_DOMAINS = [{
  ...
  var source = extractAppNameFromDomain();
  var LOGIN_URL = 'https://accounts.douban.com/popup/login?source=' + source;
  var POPUP_CSS = 'https://s.doubanio.com/dae/cdnlib/libs/components/accounts/popup.min.css';
  var OVERLAY_JS = 'https://s.doubanio.com/dae/cdnlib/libs/jquery-overlay/overlay.min.js';
  var FRAME_NAME = location.protocol + '//' + location.hostname;
  var TEMPLATE_IFRAME = '\n<iframe src="javascript:;" frameborder="0" scrolling="no" width="478" height="382" name="' + FRAME_NAME + '">\n</iframe>';
