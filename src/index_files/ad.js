    ...
    var loadFrame = function(query, parameters) {
        ...
        if (!inDocument(adFrame)) {
            ...
            if (!hasIcon) {
                ...
                var adSlotInner = global.document.createElement('div');
                var icon = global.document.createElement('div');
                icon.innerHTML = '广告'
                adSlotInner.style.position = 'relative';
                adSlotInner.style.margin = margin;
                adSlotInner.style.display = 'inline-block';
                adSlotInner.style.width = width + 'px';
                adSlotInner.style.height = height + 'px';

                icon.style.width = '40px';
                icon.style.lineHeight = '1';
                icon.style.textAlign = 'center';
                icon.style.backgroundColor = 'rgba(0, 0, 0, .3)';
                ...
                icon.style.right = '0';
                icon.style.bottom = '0';
                adSlotInner.appendChild(adFrame);
                adSlotInner.appendChild(icon);
                adSlot.appendChild(adSlotInner)
            }
        }
